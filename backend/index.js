...
const url = "mongodb+srv://admin:tESkegstLj1gmuJ4@cluster0.wvg0wnh.mongodb.net";
const bdname = "ocean_jornada_fullstack_novembro_22";

async function main() {

  // Realiza a conexao com o client
  const client = await MongoClient.connect(url);
  // Obtém acesso ao banco de dados
  const bancoDados = client.db(bdname);
...
app.get("/itens", async function (req, res) {
  ...
  // Envio todos os documentos da collection
  res.send(documentos);
});
